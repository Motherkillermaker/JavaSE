...
public class helloworld{
    ...
    //  模板二： sout / soutp / soutm / soutv / xxx.sout
        System.out.println("hello world !!!");

    //  模板三： fori  (iter/增强 For 循环 ) (itar)
        String[] arr = new String[]{"Tom","Jee","Jesus"};
    ...
    //  模板六：prs  (可生成private static final）/ psf / psfs
